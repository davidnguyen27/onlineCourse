...
const AboutPage: React.FC = () => {
  const [selectedKey, setSelectedKey] = useState('about'); // State để lưu trữ key của mục được chọn

  const handleMenuClick = (key: string) => {
    setSelectedKey(key); // Cập nhật state khi người dùng click vào một mục trong Menu
  };
  ...
  const renderContent = () => {
    switch (selectedKey) {
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 my-16">
              ...
              <div className="text-center">
                ...
                <Paragraph>
                  Hải Tú từng được biết đến là người mẫu ảnh đình đám Sài Thành, cô nàng còn được ưu ái đặt mệnh danh là nàng thơ khi sở hữu gương mặt đẹp thuần khiết, vừa mong manh lại quyến rũ. Tên tuổi của người đẹp 9x ngày càng phủ sóng rộng rãi hơn khi gia nhập công ty của nam ca sĩ đình đám Sơn Tùng M-TP. Gần đây, Hải Tú trở thành cái tên gây tranh cãi khi vướng vào lùm xùm chen chân vào mối tình giữa Sơn Tùng và Thiều Bảo Trâm.
                </Paragraph>
              </div>
              <div className="text-center">
                <div className="text-4xl">📜</div>
                ...
                <Paragraph>
                  Jack - J97, tên thật là Trịnh Trần Phương Tuấn, sinh ngày 12 tháng 4 năm 1997 tại xã Ngãi Đăng, huyện Mỏ Cày Nam, tỉnh Bến Tre.[2] Anh là con của gia đình có cha làm nghề trồng dừa và chăn dê, còn mẹ kinh doanh quán trà sữa nhỏ; hai người sau đó đã ly hôn.
                </Paragraph>
              </div>
              <div className="text-center">
                <div className="text-4xl">🌍</div>
      ...
      case 'blog':
        return (
          <>
            <Title level={2}>Blog Page</Title>
            <Paragraph>This is the Blog page content.</Paragraph>
          </>
        );
      case 'company':
        return (
          <>
            <Title level={2}>Company Page</Title>
            <Paragraph>This is the Company page content.</Paragraph>
          </>
        );
      case 'careers':
        return (
          <>
            <Title level={2}>Careers Page</Title>
            <Paragraph>This is the Careers page content.</Paragraph>
          </>
        );
      case 'press':
        return (
          <>
            <Title level={2}>Press Page</Title>
            <Paragraph>This is the Press page content.</Paragraph>
          </>
        );
      default:
        return null;
