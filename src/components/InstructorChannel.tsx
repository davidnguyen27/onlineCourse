...
interface InstructorChannelProps {
  instructor: string;
  students: number;
  likes: number;
  dislikes: number;
...
const InstructorChannel: React.FC<InstructorChannelProps> = ({ instructor, students, likes, dislikes, shares }) => {
  return (
    <div className="flex justify-between items-center mt-2 ">
      <div className="flex items-center">
        ...
        <div className="flex flex-col">
          ...
          <button type="button" className="ml-4 py-2 px-4 bg-red-500 text-white rounded">Follow</button>
        </div>
      </div>
