    ...
    <article className="w-full rounded-md bg-slate-200 drop-shadow-md">
      <div className="p-8">
        <p>
          ...
          architecto sed accusantium praesentium necessitatibus porro rem
          voluptas quidem temporibus dignissimos, autem voluptate? Illum ex
          optio, quod alias veniam itaque accusamus."
        </p>
        <div className="mt-4 flex items-center">
          <img
            ...
            alt=""
          />
          <h3 className="text-bold ml-3 font-semibold">Trần Khánh Vinh</h3>
        </div>
      </div>
    </article>
  );
