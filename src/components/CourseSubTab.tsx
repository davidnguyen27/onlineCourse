  ...
  return (
    <div className="mt-5">
      <div className="flex justify-center font-semibold border-b-2 border-gray-200">
        <button type="button" className={`py-2 px-4 ${activeTab === 'about' ? 'bg-gray-200' : ''}`} onClick={() => setActiveTab('about')}>About</button>
        <button type="button" className={`py-2 px-4 ${activeTab === 'content' ? 'bg-gray-200' : ''}`} onClick={() => setActiveTab('content')}>Course Content</button>
        <button type="button" className={`py-2 px-4 ${activeTab === 'reviews' ? 'bg-gray-200' : ''}`} onClick={() => setActiveTab('reviews')}>Reviews</button>
      </div>
      <div>
